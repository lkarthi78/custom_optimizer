...
from LU_G_Optimizer import LU_Optimizer, LUModel
...
#Optional force build before train
#_ = model(tf.zeros((1,) + x_train_s.shape[1:]), training=False)
...
x_test = np.array([
    [20.0,  18.0],   # |25-25| = 76   → medium
     [17.0, 4.0],   # |400-1| = 273 → high
    [8.0, 10.0],   # |100-64| = 36 → low
    [11.0, 6.0],  # |225-196| = 85 → medium
], dtype=np.float32)
